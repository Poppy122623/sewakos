    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link active" href="<?php echo site_url('penyewa/tagihan'); ?>">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php foreach ($datatagihan as $tagihan): ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $tagihan['tanggal_awal']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $tagihan['tanggal_akhir']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $tagihan['no_kamar']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $tagihan['periode_bulan']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $tagihan['tagihan']; ?>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            if ($tagihan['status_tagihan'] == 'Y') {
                                                                echo 'Sudah terbayar';
                                                            } else {
                                                                echo 'Belum terbayar';
                                                            } ?>
