...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('penyewa/sewakamar'); ?>">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php if (!empty($penyewa_result)): ?>
                            <ul>
                                <?php foreach ($penyewa_result as $penyewa): ?>
                                    <li><strong>Nama Lengkap:</strong>
                                        <?php echo $penyewa['nama_penyewa']; ?>
                                    </li>
                                    <li><strong>No Identitas:</strong>
                                        <?php echo $penyewa['no_identitas']; ?>
                                    </li>
                                    <li><strong>Alamat Rumah:</strong>
                                        <?php echo $penyewa['alamat_rumah']; ?>
                                    </li>
                                    <li><strong>No Telp:</strong>
                                        <?php echo $penyewa['no_telepon']; ?>
                                    </li>
                                    <li><strong>No Kontak darurat:</strong>
                                        <?php echo $penyewa['no_kontak_darurat']; ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php else: ?>
