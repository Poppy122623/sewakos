            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Sewa Kamar</h1>
                    </div>
                    <?php echo $this->session->flashdata('msg_info'); ?>
                    <!-- Content Row -->
                    <div class="row">
                        <form method="post" action="<?php echo site_url('penyewa/updatesewakamar'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select id="no_kamar" name="no_kamar" class="form-control">
                                    ...
                                    <?php $selected = ($kamar['no_kamar'] == $datasewa['no_kamar']) ? 'selected' : ''; ?>
                                    <option value="<?php echo $kamar['no_kamar']; ?>" <?php echo $selected; ?>>
                                        No. Kamar:
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_awal" name="tanggal_awal" class="form-control"
                                    value="<?php echo $datasewa['tanggal_awal']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="tanggal_akhir">Tanggal Akhir</label>
                                <input type="date" id="tanggal_akhir" name="tanggal_akhir" class="form-control"
                                    value="<?php echo $datasewa['tanggal_akhir']; ?>">
                            </div>
                            <div class="form-group">
                                <input type="hidden" id="idsewa" name="idsewa"
                                    value="<?php echo $datasewa['id_sewa']; ?>" class="form-control">
                                <button type="submit" class="btn btn-primary">Update Sewa</button>
                            </div>
                        </form>
                    </div>
                    <!-- End of Main Content -->
